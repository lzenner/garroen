...
APPEND ~%IMOEN_JOINED%~
	IF WEIGHT #-99 ~Global("#L_GIPine","GLOBAL",1)~ BEGIN PINE_1
		...
		IF ~RandomNum(8,1)~ THEN DO ~SetGlobal("#L_GIPine","GLOBAL",0) SetGlobalTimer("#L_GIPineTimer","GLOBAL",THREE_DAYS)~ EXIT
	...
	IF ~~ BEGIN PINE_2
		...
		IF ~~ THEN DO ~SetGlobal("#L_GIPine","GLOBAL",0) SetGlobalTimer("#L_GIPineTimer","GLOBAL",THREE_DAYS)~ EXIT
	END
